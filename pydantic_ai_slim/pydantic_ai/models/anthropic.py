...
# TODO(anthropic): drop the `claude-opus-5` literal once the `anthropic` floor is bumped past the
# SDK release that adds it to `ModelParam` (installed 0.119.0 still lags). See
