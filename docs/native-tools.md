...
!!! note "Anthropic Web Search Tool Versions"
    ...
    execution results are always included. Like other provider-specific options, `response_inclusion`
    is ignored by other providers and by models or clients that use the earlier tool version.
...
!!! note "Anthropic Web Fetch Tool Versions"
    ...
    Like other provider-specific options, both are ignored by other providers and by models or
    clients that use the earlier tool version.
